...
export const QuoteCalculator: React.FC<QuoteCalculatorProps> = ({ language }) => {
  ...
  return (
    <div className="max-w-4xl mx-auto">
      ...
      <div className="bg-eggshell-white/50 dark:bg-deep-ocean-surface/50 p-6 sm:p-10 rounded-lg shadow-2xl border border-raisin-black/10 dark:border-eggshell-white/10">
        {renderStep()}
      </div>
    </div>
  );
